...
state_gov_2021 %>% write.csv("state_gov_2021.csv")
```
...
acfrs_city_place_pop_21 %>% write.csv("acfrs_city_place_pop_21.csv")
acfrs_city_place_pop %>% filter(str_detect(city_place, "town"))
```
...
alaska_borough_acfrs_21 <- acfrs_NOT_cityplace_21 %>% 
  filter(state.abb == "AK") %>% 
...
county_pop_census_acfrs_21 %>% write.csv("county_pop_census_acfrs_21.csv")
```
...
acfrs_geoID_NO_population_21 <- acfrs_NOT_cityplace_21 %>% 
  ...
  acfrs_geoID_NO_population_21 %>% write.csv("acfrs_geoID_NO_population_21.csv")
